package sanchana.bagShop.asset.color.controller;



import sanchana.bagShop.asset.color.entity.ItemColor;
import sanchana.bagShop.asset.color.service.ItemColorService;
...
//read
    ...
    public String findAll(Model model) {
        model.addAttribute("brands", itemColorService.findAll());
